...
const Tag = ({ title }: TagProps) => {
  return (
    <span
      className="px-1 py-0 rounded-sm shadow-sm text-xs font-mono font-regular text-gray-600
      ...
      dark:bg-opacity-100 dark:bg-gray-700 dark:text-gray-300 dark:bg-gradient-to-l dark:from-gray-900 dark:to-gray-900 dark:via-almostblack
